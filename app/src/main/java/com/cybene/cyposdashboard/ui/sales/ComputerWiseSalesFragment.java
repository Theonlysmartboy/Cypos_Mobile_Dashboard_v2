...
public class ComputerWiseSalesFragment extends Fragment {
    ...
    private void getRangeBasedData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_COMPUTER_WISE_SALE, response -> {
    ...
    private void getData() {
        ...
        call.enqueue(new Callback<>() {
            ...
            @Override
            public void onFailure(@NonNull Call<List<ComputerWiseSalesGrid>> call, @NonNull Throwable t) {
    ...
    private void setBackground() {
        ...
        for (int i=0; i<numRows;i++) {
            if(i%2==1){
                items.getChildAt(i).setBackground(ContextCompat.getDrawable(requireActivity(), R.drawable.table_title_border));
            }else{
                items.getChildAt(i).setBackground(ContextCompat.getDrawable(requireActivity(), R.drawable.table_border));
            }
        }
    }
