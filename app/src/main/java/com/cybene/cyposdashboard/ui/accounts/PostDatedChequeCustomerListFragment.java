...
public class PostDatedChequeCustomerListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_accounts_post_dated_cheque_customer_list, container, false);
    ...
    private void getData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_POST_DATED_CHEQUE_CUSTOMER_LIST, response -> {
