package com.cybene.cyposdashboard.ui.accounts;
...
public class PostDatedChequeCustomerListFragment extends Fragment {
    ...
    public PostDatedChequeCustomerListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_post_dated_cheque_customer_list, container, false);
    ...
    private void getData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_POST_DATED_CHEQUE_CUSTOMER_LIST, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0; i<jsonArray.length();i++){
                        ...
                        month.setText(jsonObject.getString("CustomerName"));
                        sales.setText(jsonObject.getString("Date"));
