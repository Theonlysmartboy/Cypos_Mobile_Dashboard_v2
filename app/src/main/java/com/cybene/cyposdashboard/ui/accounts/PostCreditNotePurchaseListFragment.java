...
public class PostCreditNotePurchaseListFragment extends Fragment {
    ...
    public PostCreditNotePurchaseListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_post_credit_note_purchase_list, container, false);
    ...
    private void getData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_POST_DATED_CREDIT_NOTE_PURCHASE_LIST, new com.android.volley.Response.Listener<String>() {
            @Override
