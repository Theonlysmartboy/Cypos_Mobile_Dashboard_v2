...
public class PaymentListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_payment_list2, container, false);
    ...
    private void getData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_PAYMENT_LIST_2, new com.android.volley.Response.Listener<String>() {
            @Override
