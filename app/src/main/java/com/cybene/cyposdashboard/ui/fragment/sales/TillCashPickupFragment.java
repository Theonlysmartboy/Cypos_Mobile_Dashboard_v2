...
public class TillCashPickupFragment extends Fragment {
    ...
    private void getRangeBasedData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_TILL_CASH_PICKUP, response -> {
    ...
    private void getData() {
        ...
        call.enqueue(new Callback<>() {
            ...
            @Override
            public void onFailure(@NonNull Call<List<TillCashPickupList>> call, @NonNull Throwable t) {
