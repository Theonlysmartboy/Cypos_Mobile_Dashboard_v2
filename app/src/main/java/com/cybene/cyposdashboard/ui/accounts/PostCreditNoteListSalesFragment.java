...
public class PostCreditNoteListSalesFragment extends Fragment {
    ...
    public PostCreditNoteListSalesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_post_credit_note_sales_list, container, false);
    ...
    private void getData(final String fromVal, final String toVal) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_POST_DATED_CREDIT_NOTE_SALES_LIST, new com.android.volley.Response.Listener<String>() {
            @Override
