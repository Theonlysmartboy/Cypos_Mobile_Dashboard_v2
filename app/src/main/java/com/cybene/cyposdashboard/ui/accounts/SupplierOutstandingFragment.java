...
public class SupplierOutstandingFragment extends Fragment {
    private TableLayout items;
    TextView id,month,sales, amount;
    View tableRow;
    int idNo;
    LinearLayout parentContainer;
    public SupplierOutstandingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_supplier_outstanding, container, false);
    ...
    private void getData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, AppConfig.URL_SUPPLIER_OUTSTANDING, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0; i<jsonArray.length();i++){
                        ...
                        sales.setText(jsonObject.getString("Balance"));
