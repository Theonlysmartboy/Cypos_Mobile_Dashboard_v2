package com.cybene.cyposdashboard.ui.fragment.inventory;
...
public class DepartmentWiseStockValuationFragment extends Fragment {
    private TableLayout items;
    TextView id,month,sales, amount;
    View tableRow;
    int idNo;
    LinearLayout parentContainer;

    public DepartmentWiseStockValuationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_department_wise_stock_valuation, container, false);
    ...
    private void getData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, AppConfig.URL_DEPT_WISE_STOCK, response -> {
            ...
            try {
                ...
                for(int i=0; i<jsonArray.length();i++){
                    ...
                    tableRow = LayoutInflater.from(getActivity()).inflate(R.layout.table_item2, null, false);
                    //table components
                    ...
                    month.setText(jsonObject.getString("DepartmentName"));
                    sales.setText(jsonObject.getString("ValueCP"));
                    amount.setText(jsonObject.getString("ValueSP"));
