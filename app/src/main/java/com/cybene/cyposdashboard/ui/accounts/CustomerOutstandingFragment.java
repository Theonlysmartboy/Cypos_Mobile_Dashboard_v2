...
public class CustomerOutstandingFragment extends Fragment {
    ...
    public CustomerOutstandingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_customer_outstanding, container, false);
    ...
    private void getData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, AppConfig.URL_CUSTOMER_OUTSTANDING, new com.android.volley.Response.Listener<String>() {
            @Override
